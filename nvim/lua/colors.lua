vim.cmd([[
  ...
  autocmd InsertLeave * hi Normal guibg=#fefafb
  ...
  let s:bg3="#d5d2d3"
  let s:bg4="#c1bebf"
  let s:linenumber="#d9526b"
  let s:keyword="#ac5065"
  let s:builtin="#d4678e"
  let s:const= "#d9526b"
  let s:comment="#f2bbc5"
  let s:func="#dc5d64"
  let s:str="#7a3a54"
  let s:type="#ba6186"
  let s:var="#d9526b"
  ...
  exe 'hi CursorLineNr guifg='s:fg' guibg='s:linenumber
